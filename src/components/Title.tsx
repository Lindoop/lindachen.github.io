...
export default function Title() {
    ...
    return (
        <div id="title" className="relative w-full text-white">
            <img src={Astronaut} className="astronaut-float astronaut-float absolute top-[50vh] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[35vw] pointer-events-none"/>
